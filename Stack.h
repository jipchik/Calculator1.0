  ...
  public:
    ...
    empty_exception (const char * msg)
      : std::exception (msg) { }
		...
		//overriding the what() from std::exception to customize throw message	
...
private:
  ...
  // using aggregation, the stack_ is of type Array
  Array <T> stack_;
	//top_index_ keeps track of the current top index of the stack
 	int top_index_;
	//size_ is the current number of elements in the stack
	int size_;
};
